...
Product_Allocated_Area = st.number_input("Product_Allocated_Area", min_value=0.0, value=12.66)
...
Store_Age_Years = st.number_input("Store_Age_Years", min_value=1, value=50)
...
if uploaded_file is not None:
    if st.button("Forecast Batch", type="primary"):
        ...
        if response.status_code == 200:
            ...
            st.error("Unable to connect to the forecast API.")
